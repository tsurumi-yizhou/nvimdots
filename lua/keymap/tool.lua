...
local plug_map = {
	...
	-- Plugin: nvim-tree
	["n|<leader>e"] = map_cr("NvimTreeOpen"):with_noremap():with_silent():with_desc("filetree: Open"),
	["n|<leader>o"] = map_cr("NvimTreeFocus"):with_noremap():with_silent():with_desc("filetree: Focus"),
